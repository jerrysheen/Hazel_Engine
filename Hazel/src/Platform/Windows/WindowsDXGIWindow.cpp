...
namespace Hazel 
{
	...
	void WindowsDXGIWindow::OnResize()
	{
		assert(md3dDevice);
		assert(mSwapChain);
	...
	void WindowsDXGIWindow::FlushCommandQueue()
	{
	...
	void WindowsDXGIWindow::LogAdapters()
	{
		UINT i = 0;
	...
	void WindowsDXGIWindow::LogAdapterOutputs(IDXGIAdapter* adapter)
	{
		UINT i = 0;
	...
	void WindowsDXGIWindow::LogOutputDisplayModes(IDXGIOutput* output, DXGI_FORMAT format)
	{
		UINT count = 0;
		UINT flags = 0;
	...
	void WindowsDXGIWindow::CreateCommandObjects()
	{
