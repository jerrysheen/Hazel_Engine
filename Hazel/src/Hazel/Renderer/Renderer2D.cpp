...
namespace Hazel {
	...
	void Renderer2D::Init()
	{
		...
		s_Data->ParticleShader = Shader::Create("assets/shaders/FlatColor.glsl");
	...
	void Renderer2D::BeginScene(const OrthographicCamera& camera)
	{
		...
		s_Data->ParticleShader->SetMat4("u_ViewProjection", camera.GetProjectionMatrix());
	...
	void Renderer2D::DrawQuad(const glm::vec3& position, const glm::vec2& size, const Texture& texture)
	{
		s_Data->TextureShader->Bind();
